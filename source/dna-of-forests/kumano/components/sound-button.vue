...
a(v-on:click="click")
  div
    span SOUND
  audio(loop)
    source(src='/dna-of-forests/kumano/sound/forest.mp3' type='audio/mp3')
...
a
  >div
    ...
    background-image: url(/dna-of-forests/kumano/img/gnav/sound-on@2x.png)
  ...
  &.off
    >div
      background-image: url(/dna-of-forests/kumano/img/gnav/sound-off@2x.png)
