...
article
  ...
  section
    ...
    p
      | YCAMバイオ・リサーチのワークショップ「森のDNA」の参加者と山口市の仁保の森で生き物を採集し、顕微鏡での観察記録やDNA解析の結果を収録しています。仁保の森のある地点から、ぐるっと360°パノラマの風景を見渡し、ワークショップ参加者が採集した情報を引き出すことができます。<br>
      | 私達が何気なく見ている自然の風景にも、たくさんの情報が眠っています。「森のDNA」は、その眠っている情報を自分たちで採集しながら、ひとつの図鑑をつくることを通じて、複眼的な見方を養っていくプロジェクトです。<br>
      | この「森のDNA」は、ロンドンを拠点に活躍するクリエティブ・スタジオ「マシュマロ・レーザー・フィースト（MLF）」によるバーチャル・リアリティ作品「もしも、森の生き物になったら」の仁保の森ツアープログラムとして開催されました。
  ...
  section#dna-barcoding
    ...
    p
      ...
      | また、検索にはバイオインフォマティクスでDNAの類似した部分を並べて照らし合わせることができる「BLAST」と呼ばれるプログラムを利用しました。
    a.btn(href="https://blast.ncbi.nlm.nih.gov/Blast.cgi" target="_blank") BLAST: Basic Local Alignment Search Tool
  section
    h2
    ...
    a.btn(href="https://goo.gl/maps/Fm9EAftjMMA2" target="_blank") サンプルの採取地点をGoogleMapsで見る

  section#credit
    h3
      img(alt='制作・協力' src='img/about/title-credit.png' srcset='img/about/title-credit@2x.png 2x')
    p
